...
from controllers.clients_controller import create_cliente, read_clientes, update_cliente, delete_cliente
from controllers.incidents_controller import create_incidente, read_incidentes, update_incidente, delete_incidente
from controllers.installations_controller import create_instalacion, read_instalaciones, update_instalacion, delete_instalacion
from controllers.personal_controller import create_personal, read_personal, update_personal, delete_personal
...
class SecureSysApp(tk.Tk):
    ...
    def show_clientes_view(self):
        ...
        tk.Button(btn_frame, text='Exportar PDF', command=self.export_clientes_pdf).pack(side='left', padx=5)
    ...
    def export_clientes_pdf(self):
        try:
            ...
            elements = []
            elements.append(Paragraph("Reporte: Clientes", styles['Heading2']))
    ...
    def show_incidentes_view(self):
        ...
        tk.Button(btn_frame, text='Exportar PDF', command=self.export_incidentes_pdf).pack(side='left', padx=5)
    ...
    def export_incidentes_pdf(self):
        try:
            ...
            styles = getSampleStyleSheet()
            elements = []
            elements.append(Paragraph("Reporte: Incidentes", styles['Heading2']))
            elements.append(Paragraph(f"Generado: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}", styles['Normal']))
            elements.append(Spacer(1, 12))
    ...
    def show_instalaciones(self):
        ...
        tk.Button(btn_frame, text='Exportar PDF', command=self.export_instalaciones_pdf).pack(side='left', padx=5)
    ...
    def export_instalaciones_pdf(self):
        try:
            ...
            styles = getSampleStyleSheet()
            elements = []
            elements.append(Paragraph("Reporte: Instalaciones", styles['Heading2']))
            elements.append(Paragraph(f"Generado: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}", styles['Normal']))
            elements.append(Spacer(1, 12))
    ...
    def show_personal_view(self):
        ...
        tk.Button(btn_frame, text='Exportar PDF', command=self.export_personal_pdf).pack(side='left', padx=5)
    ...
    def export_personal_pdf(self):
        try:
            ...
            styles = getSampleStyleSheet()
            elements = []
            elements.append(Paragraph("Reporte: Personal de Seguridad", styles['Heading2']))
            elements.append(Paragraph(f"Generado: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}", styles['Normal']))
            elements.append(Spacer(1, 12))
